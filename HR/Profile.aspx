<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Profile.aspx.cs" Inherits="HR_Profile" %>
    ...
    <li>
        <div id="content">
	        ...
	        <tr><td class="style1"><center>
             ...
             <tr><td class="style1"><center><br /></td>
                            <td class="bodyText">
                                </td>
             </tr>
	        ...
	        <br /><br />	        
	        <center> New User <a href="hr_login.aspx" class="style5"> Click Here </a></center>	        
	        </div>!-->
            </div></div></li>
            </ul>                 
      </div>
