...
public partial class HR_SearchResume : System.Web.UI.Page
{
    ...
    protected void searchjobs_Click(object sender, EventArgs e)
    {
        ...
        str = "select js_profile.jsid as jsid,qualification,email,total_exp,months,current_industry,functional_area,skill1,skill2,skill3 from js_profile,js_login where (skill1 in (" + sr + ") or skill2 in (" + sr + ") or skill3 in (" + sr + ")) and total_exp>=" + experience.SelectedIndex +" and js_profile.jsid=js_login.jsid";
        Session["str1"] = str;
        srjobs();
    }
    protected void srjobs()
    {
        ...
        //DataTable hrjob = new DataTable("hrjob");
        da.Fill(ds, "jsprof");
        //ds.Tables.Add(hrjob);
        ...
        //    a1.Columns["location"]= (DataColumn)(ds.Tables["hrjob"].Columns["location"]);
        a1.Columns.Add("email", typeof(string));
        //    ds.Tables["hrjob"].Columns["name"] + ", Min Exp : " + ds.Tables["hrjob"].Columns["exp_req"];
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "cmdBind")
        {
            ...
            Response.Redirect("../JS/Jobdetails.aspx?jid=" + l.Text + "");
        }
        if (e.CommandName == "apply")
        {
            LinkButton l1 = (LinkButton)e.CommandSource;
            //int i1 = GridView1.SelectedIndex;
            //GridViewRow rr = GridView1.Rows[i1];            
            string k = l1.ToolTip.ToString();
            string[] s = new string[2];
            s[0] = k;
            s[1] = "";
            Session["sendmailmsg"] = k;
            Response.Redirect("../HR/sendmail.aspx");
        }
    }
