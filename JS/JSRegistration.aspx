<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JSRegistration.aspx.cs" Inherits="JS_JSRegistration" %>
...
<link rel="stylesheet" href="Images/myclass.css" type="text/css" />
    ...
    function aa(){
        if(document.getElementById("fresher").getAttribute("value")==true)
        {        
            document.getElementById("Label10").getAttribute("Text") = "Hello        ";
        }
    }
</script>!-->
</head>
<body>
    ...
    <asp:Label ID="Label1" runat="server" Text="EMail"></asp:Label>            </td>
        ...
        <asp:TextBox ID="mailid" CssClass="style3" runat="server" ValidationGroup="t1" 
                AutoPostBack="True" ontextchanged="mailid_TextChanged" ></asp:TextBox>&nbsp;</td>
        <td>
...
&nbsp;&nbsp;</td>
    ...
    <tr><td><asp:Label ID="Label2" runat="server" Text="Password"></asp:Label>            </td>
        ...
        <td>
            <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" 
                ControlToValidate="pwd" ErrorMessage="Password Min. of 6 Chars" 
    ...
    <td>&nbsp;</td></tr>
        ...
        <tr><td><asp:Label ID="Label17" runat="server" Text="Gender"></asp:Label></td><td></td>
        <td>
            <br />
            <asp:RadioButton ID="male" runat="server" BackColor="White" 
                CssClass="title" Font-Bold="True" ForeColor="Black" GroupName="a1" 
                Text="Male" Font-Size="Small" />
            <asp:RadioButton ID="female" runat="server" BackColor="White" 
                CssClass="title" Font-Bold="True" ForeColor="Black" GroupName="a1" 
                Text="Female" />
            </td></tr>
        <tr><td><br /></td></tr>
    ...
    <tr> <td colspan="4">   <center>
        <br />
        <asp:Button ID="Button1" runat="server" Text="Submit" CssClass="style2" onclick="Button1_Click" /></center> </td></tr></table>
    </div>
    </div></div>
    </div>
    </form>
