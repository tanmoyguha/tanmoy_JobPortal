<%@ Page Language="C#" AutoEventWireup="true" CodeFile="userlogin.aspx.cs" Inherits="anyuser_userlogin" %>
...
<body>
	...
	<tr>
	    ...
	    <td bgcolor="#FFFFCA" height="70" colspan="3" class="logo" nowrap="nowrap"> &nbsp;&nbsp; ZenithJobs |<span class="tagline">|&nbsp;&nbsp;Jobs </span></td>
	    <!--<td width="40">&nbsp;</td>
	    <td width="100%">&nbsp;</td>!-->
	</tr>
	    ...
	    <td width="705" colspan="3" height="24">
	        <table border="0" cellpadding="0" cellspacing="0" id="navigation">
                <tr>
                    ...
                    <td class="navText" align="center" nowrap="nowrap"><a href=""> SEARCH JOBS </a></td>
                    <td class="navText" align="center" nowrap="nowrap"><a href=""> PLACEMENT PAPERS </a></td>
                    <td class="navText" align="center" nowrap="nowrap"><a href=""> MY PROFILE </a></td>
	...
	<tr><td bgcolor="#F3F3F3" colspan="100%"><asp:Label class="style6" Width="100%" id="a" runat="server"></asp:Label></td></tr>
	<tr>
<!--	    <td width="50%"> </td>	
	    <td width="100%">
	    <br />
	    ...
	    <h2 class="title"> JobSeeker Login <br /> <br /></h2>	    
...
<!--	        <table width="100%" border="0" cellspacing="0" cellpadding="0">
	     ...
	     <!--           </td>
	        ...
	        <br />
	        <br />	        
	        <center> User <a href="jss_login.aspx" class="style5"> Click Here </a> </center>
	    </td>	
	</tr>		
</table>
